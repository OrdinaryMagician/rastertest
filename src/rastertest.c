...
face_t cubefaces[12] =
{
	{{0,6,4},{0,0,0},{0,0,0},{0,6,4},0},
	{{0,2,6},{0,0,0},{0,0,0},{0,2,6},0},
	{{0,3,2},{0,0,0},{0,0,0},{0,3,2},0},
	{{0,1,3},{0,0,0},{0,0,0},{0,1,3},0},
	{{2,7,6},{0,0,0},{0,0,0},{2,7,6},0},
	{{2,3,7},{0,0,0},{0,0,0},{2,3,7},0},
	{{4,6,7},{0,0,0},{0,0,0},{4,6,7},0},
	{{4,7,5},{0,0,0},{0,0,0},{4,7,5},0},
	{{0,4,5},{0,0,0},{0,0,0},{0,4,5},0},
	{{0,5,1},{0,0,0},{0,0,0},{0,5,1},0},
	{{1,5,7},{0,0,0},{0,0,0},{1,5,7},0},
	{{1,7,3},{0,0,0},{0,0,0},{1,7,3},0}
};
model_t cube =
{
...
void filltriangle( px_t p[3], color_t c[3] )
{
	px_t minb, maxb;
